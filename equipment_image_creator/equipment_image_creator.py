...
def create_image(equipped):
    image = Image.open("/root/bot/images/equipment/inventory.png")
    if equipped.get("gun_1"):
        gun_1 = Image.open("/root/bot/images/equipment/images/gun1.png")
        image = merge_image(image, gun_1, (100, 296))
    if equipped.get("gun_2"):
        gun_2 = Image.open("/root/bot/images/equipment/images/gun2.png")
        image = merge_image(image, gun_2, (70, 30))
    if equipped.get("patrons"):    
        ammo = Image.open("/root/bot/images/equipment/images/ammo.png")
        image = merge_image(image, ammo, (100, 444))
    if equipped.get("armor"):
        armor = Image.open("/root/bot/images/equipment/images/armor.png")
        image = merge_image(image, armor, (805, 236))
    if equipped.get("helmet"):
        helmet = Image.open("/root/bot/images/equipment/images/helmet.png")
        image = merge_image(image, helmet, (805, 56))
    if equipped.get("cold_gun_1"):
        knife = Image.open("/root/bot/images/equipment/images/knife.png")
        image = merge_image(image, knife, (790, 626))
    if equipped.get("pocket"):
        stimulator = Image.open("/root/bot/images/equipment/images/stimulator.png")
